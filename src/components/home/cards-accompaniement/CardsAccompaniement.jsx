...
import holistique from '@/assets/photos/accompagnement-holistique.jpg';
const cards = [
  { title: 'Harmonisation du corps et de l’esprit', image: harmonisation, link: '/accompagnements#harmonisation' },
  { title: 'Voyages sonores & massages aux bols', image: voyage, link: '/accompagnements#voyages' },
  { title: 'Accompagnement holistique', image: holistique, link: '/accompagnements#accompagnement' }
];
