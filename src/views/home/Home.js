  ...
  return (
    <div className="home">
      <div className="home-container">
        ...
        <p>
          J'accueille celles qui traversent une période de mal-être, de fatigue émotionnelle ou de perte de sens, et je
          les guide avec douceur vers un mieux-être global.
        </p>
        <p>
